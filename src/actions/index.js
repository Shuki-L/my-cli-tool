...
const { githubApp } = require("../actions/github");
...
const performAction = async (answers, ctx) => {
  if (typeof answers.choice === "function") {
    ...
    switch (answers.choice) {
      case ACTIONS.GITHUB_ACTIONS_MENU:
        getMenu(MENUS.GITHUB, ctx);
        break;
      case ACTIONS.GITHUB_APP_GET_INSTALLATIONS:
        await githubApp.getAppInstallations(ctx);
        break;
